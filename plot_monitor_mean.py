            ...
            for i in range(0, len(tab) * 2 + 1):
                for j in range(0, len(array_mon[t][i])):
                    if j < len(mean_array_mon[i]) and len(mean_array_mon[i]) != 0:
                        mean_array_mon[i][j][0] = (mean_array_mon[i][j][0] * mean_array_mon[i][j][1] + array_mon[t][i][
                            j]) / (mean_array_mon[i][j][1] + 1)
            ...
            for i in range(0, len(tab) * 2 + 1):
                for j in range(0, len(array_nomon[t][i])):
                    if j < len(mean_array_nomon[i]) and len(mean_array_nomon[i]) != 0:
                        mean_array_nomon[i][j][0] = (mean_array_nomon[i][j][0] * mean_array_nomon[i][j][1] +
                                                     array_nomon[t][i][j]) / (mean_array_nomon[i][j][1] + 1)

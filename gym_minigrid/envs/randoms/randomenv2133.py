...
class RandomEnv20x20_2133(RandomEnv):
    def __init__(self):
        super().__init__(size=20)

register(
    id='MiniGrid-RandomEnv-20x20-2133-v0',
    entry_point='gym_minigrid.envs:RandomEnv20x20_2133'
)

...
class Action:
    ...
    def __init__(self, name: ExMiniGridEnv.Actions, current_cell: Cell, orientation: StateEnum):
        ...
        if name == ExMiniGridEnv.Actions.forward:
            if orientation == Orientation.north and current_cell.north_cell is not None:
            ...
            elif orientation == Orientation.south and current_cell.south_cell is not None:
            ...
            elif orientation == Orientation.west and current_cell.west_cell is not None:
            ...
            elif orientation == Orientation.east and current_cell.east_cell is not None:
